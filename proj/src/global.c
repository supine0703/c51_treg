...
// 与at24c02进行通信需要的变量
uchar settingsSave = 0x00;

// ==================== ===== ====================

// ==================== 为了播放音乐而定义 ====================

uint freqDelay = 0x20, freqSize = 600;
uchar freqH = 0xfc, freqL = 0x18, freqSelect = 0; 
uchar idata musicArr[97]; // 存储音乐节拍索引

uint code FreqTable[] = { // 索引与频率对照表
    0,     // 0
    63628, // 1
    63731, // 2
    63835, // 3
