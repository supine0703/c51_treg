...
{
	LCD1602_Set_8bit_2line_5x7();	// 命令6
	LCD1602_CursorOFF(); 			// 命令4
	LCD1602_Mode_CursorRightMove(); // 命令3
	LCD1602_Clear(); 				// 命令1
	Delay(1);
}
...
void LCD1602_ScreenMultipleRight(uchar num, uint t)
{
	do
	{
		LCD1602_ScreenShiftRight();
		Delay(t);
	} while (--num);
}
